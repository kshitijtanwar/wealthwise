const Services = () => {
    ...
    return <section className="min-vh-80 py-3 pb-5 py-xl-8" id="services">
        ...
        <div className="container">
            ...
            <div className="row justify-content-md-center">
                ...
                <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                    ...
                    <h2 className="mb-4 display-5 text-center">Our Core Services <span className="text-primary">Excellence</span></h2>

                    <p className="text-secondary mb-5 text-center lead fs-4">

                        Unlock your financial potential with holistic planning, gain clarity with insightful visualizations, and move forward confidently

                        with uncompromising data security protecting your journey.
                                ...
                                <div className="card border-dark">
                                    ...
                                    <div className="card-body p-3 p-md-4 p-xxl-5 d-flex justify-content-center align-items-center">
                                        ...
                                        <div className="me-3 text-primary">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="bi bi-basket2-fill" viewBox="0 0 16 16">
                                        ...
                                        <div>
                                            ...
                                            <h4 className="mb-1">Financial Planning</h4>

                                            <p className="m-0 text-secondary">Personalized strategies to achieve financial planning.</p>
                                ...
                                <div className="card border-dark">
                                    ...
                                    <div className="card-body p-3 p-md-4 p-xxl-5 d-flex justify-content-center align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h4 className="mb-1">Data Visualization</h4>

                                            <p className="m-0 text-secondary">Gain deeper insights into your financial activities with intuitive and interactive visualizations.</p>
                                ...
                                <div className="card border-dark">
                                    ...
                                    <div className="card-body p-3 p-md-4 p-xxl-5 d-flex justify-content-center align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h4 className="mb-1">Data Security</h4>

                                            <p className="m-0 text-secondary">User data is encrypted and privacy is maintained at all points.</p>
