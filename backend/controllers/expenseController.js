...
exports.addExpense = async (req, res, next) => {
    try {
        ...
        // Find active budget for this user/category/period
        ...
        let alert = null;
        if (budget) {
            // Sum expenses for this category and period
            ...
            if (spent >= budget.amount * budget.notifyOn) {
...
exports.importExpenses = async (req, res, next) => {
    try {
        ...
        res.json({ message: "Expenses imported", imported });
    } catch (error) {
        next(error);
    }
};
